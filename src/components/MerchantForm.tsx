...
const MerchantForm = ({ insertApi }: { insertApi: any }) => {
  ...
  return (
    <div className="mx-4 my-20 flex w-[95%] flex-col justify-between gap-2 sm:flex-row md:mx-auto md:w-4/5 md:gap-20 ">
...
<FormField
            ...
            <div>
              ...
              <p className="mb-2 text-sm font-normal text-gray-400">
                This section allows you to create custom fields for your form
                and collect information from there.
              </p>
